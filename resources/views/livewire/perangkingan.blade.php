  ...
  <div class="w-[912px]">
    ...
    <div class="p-4 w-[912px] bg-[#bdd1ff9e] mx-auto w-full space-y-3 flex flex-col justify-start">
      ...
      <div class="!mt-6 !mb-4 text-white">
        Silahkan memilih jumlah peserta yang dianggap lulus berdassarkan nilai
      </div>
      <div x-data class="flex space-x-4">
        <input type="number" x-ref="id" id="" class="w-full bg-white opacity-90 p-2 text-sm" />
        <button class="btn bg-white text-[#040056] text-sm p-4" @click="$wire.lulus($refs.id.value)">Luluskan</button>
      </div>
    </div>
  </div>
</div>
